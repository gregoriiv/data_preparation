...
class PrepareLayers():
    ...
    def __init__(self,Database ,is_temp = True):
        ...
        with open(Path.cwd().parent/'config/db.yaml', encoding="utf-8") as stream:
...
# run in Container, but add mapconfig.xml in data folder beforehand e.g. copy from main goat repo
