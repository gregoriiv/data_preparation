...
UPDATE ways SET impedance_surface = ('{json.dumps(var["variable_container"]["cycling_surface"])}'::jsonb ->> surface)::NUMERIC 
WHERE surface IS NOT NULL
AND surface IN(SELECT jsonb_object_keys('{json.dumps(var["variable_container"]["cycling_surface"])}'::jsonb));
